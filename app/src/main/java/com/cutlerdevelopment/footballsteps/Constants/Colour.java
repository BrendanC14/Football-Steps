...
public class Colour {
    ...
    private static final int RED_COLOUR = android.R.color.holo_red_dark;
    private static final int RED_BGROUND_TEXT_COLOUR = android.R.color.white;
    private static final int DARK_BLUE = 2;
    private static final int DARK_BLUE_COLOUR = android.R.color.holo_blue_dark;
    private static final int DARK_BLUE_BGROUND_TEXT_COLOUR = android.R.color.white;
    private static final int WHITE = 3;
    private static final int WHITE_COLOUR = android.R.color.white;
    private static final int WHITE_BGROUND_TEXT_COLOUR = android.R.color.black;
    private static final int ORANGE = 4;
    private static final int ORANGE_COLOUR = android.R.color.holo_orange_dark;
    private static final int ORANGE_BGROUND_TEXT_COLOUR = android.R.color.black;
    private static final int GREEN = 5;
    private static final int GREEN_COLOUR = android.R.color.holo_green_dark;
    private static final int GREEN_BGROUND_TEXT_COLOUR = android.R.color.black;
    private static final int BLACK = 6;
    private static final int BLACK_COLOUR = android.R.color.black;
    private static final int BLACK_BGROUND_TEXT_COLOUR = android.R.color.white;
    private static final int LIGHT_BLUE = 7;
    private static final int LIGHT_BLUE_COLOUR = android.R.color.holo_blue_light;
    private static final int LIGHT_BLUE_BGROUND_TEXT_COLOUR = android.R.color.white;
    private static final int PURPLE = 8;
    private static final int PURPLE_COLOUR = android.R.color.holo_purple;
    private static final int PURPLE_BGROUND_TEXT_COLOUR = android.R.color.white;
